...
Tutorial video: https://youtu.be/90my8LSSXck
    ...
    •Auto (Nothing touched, except the bitrate, deleting THM files, 4GB files, JPEG 100%)
...
• 2.1.0.	Minor bugfixes
			Moved everything to website: xs-Sol.com & created self installer/uninstaller
