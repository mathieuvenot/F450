...
#Sources: Based on Yimax(by nutsey), PJanisio, Dashcamtalk,
#Description: Yitune is created for people who know how to edit videos, and are
#looking for high dynamic videos with less compressions. So what Yitune does is lower saturation,
#lower sharpness and lower contrast so the user has all the freeness to create their personal
...
t ia2 -adj ev 10 0 70 0 0 130 0
